...
// Pages render their own content area with absolute positioning relative to the shell.
// ─────────────────────────────────────────────────────────────
function Shell({ page, onPage, children }) {
  const t = useTheme();
  return (
    <div style={{
...
Object.assign(window, { Shell, Surface, TopPill, BottomNav, StatusBar, HomeIndicator, IconBtn, NAV_PAGES, W, H });
