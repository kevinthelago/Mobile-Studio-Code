    ...
    <>
      ...
      <div style={{ position: 'absolute', top: 134, left: 16, right: 16, zIndex: 5 }}>
        <Surface style={{
          ...
          <IconBtn>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="2" y="3" width="3" height="8" rx="0.5"/><rect x="9" y="3" width="3" height="8" rx="0.5"/></svg>
          </IconBtn>
        </Surface>
      </div>
