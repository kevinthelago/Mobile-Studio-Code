    ...
    <>
      ...
      <div style={{ position: 'absolute', top: 60, left: 24, right: 24, zIndex: 5 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: 2 }}>
          <span style={{ fontSize: 28, fontWeight: 700, letterSpacing: -0.6, color: t.fg }}>llm-cli</span>
          <span style={{ fontSize: 13, color: t.fgMuted }}>· 14 files</span>
        </div>
      </div>

      {/* Search pill */}
      <div style={{ position: 'absolute', top: 130, left: 16, right: 16, height: 44, zIndex: 5 }}>
        <Surface style={{
      ...
      {/* Recents row */}
      <div style={{ position: 'absolute', top: 188, left: 0, right: 0, zIndex: 5 }}>
      ...
      {/* Tree section title */}
      <div style={{ position: 'absolute', top: 290, left: 24, right: 24, fontSize: 11, letterSpacing: 1.2, textTransform: 'uppercase', color: t.fgDim, fontWeight: 600, zIndex: 5,
      ...
      {/* Tree */}
      <div style={{ position: 'absolute', top: 316, left: 12, right: 12, bottom: 110, overflow: 'hidden', zIndex: 5 }}>
